...
| 2026 | 生成 AI 向けセキュリティ外部ハーネス | 監査ポリシーを踏まえたログ保管設計のコンサルから PM まで単独担当。Sensitive Data Protection（DLP API）、Vertex AI Gen AI evaluation service、Model Armor を組み合わせた外部セキュリティハーネスを構築 |
