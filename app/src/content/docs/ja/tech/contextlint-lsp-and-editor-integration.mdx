...
<Image src={diagnosticImage} alt="TBL-001 の違反とホバーで表示されるルール詳細" quality={80} />
...
<Image src={overviewImage} alt="複数ルールの違反が同じファイル上で同時に診断される様子" quality={80} />
...
<Image src={quickfixPopupImage} alt="TBL-002 の Quick Fix ポップアップ" quality={80} />
*TBL-002 の Quick Fix — 1 つの Code Action で空セルに `TODO` プレースホルダーが挿入される。*

<Image src={quickfixAppliedImage} alt="Quick Fix 適用後のエディタの状態" quality={80} />
