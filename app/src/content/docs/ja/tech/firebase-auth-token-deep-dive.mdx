...
import firebaseAuthTokenDeepDiveOg from '../../../../assets/og/firebase-auth-token-deep-dive.png';

<SiteImage src={firebaseAuthTokenDeepDiveOg} alt="og" variant="hero" widths={[375, 750, 1500]} style="width: 100%; height: auto;" />
