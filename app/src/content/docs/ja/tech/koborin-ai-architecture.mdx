...
<SiteImage src={gcsImage} alt="gcs" variant="inline" />
...
<SiteImage src={dnsImage} alt="dns" variant="inline" />
...
<table>
  ...
  <tbody>
    <tr><td>アクセス時</td><td><SiteImage src={iap1Image} alt="iap-1" variant="inline" /></td></tr>
    <tr><td>アクセス拒否時</td><td><SiteImage src={iap2Image} alt="iap-2" variant="inline" /></td></tr>
  </tbody>
</table>
