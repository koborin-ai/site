...
実際のニュースレターは、こちらで公開しています。

<RichLinkCard href="/stars/" title="koborin.ai/stars" description="star した OSS を、毎朝ひとつ自分宛てに紹介するニュースレター" />
...
もう少し大きく言うと、私が大事だと思っているのは、新しいものを追うこと自体よりも、集めた情報を自分の文脈（スタックや、これまで作ってきたもの、考え方）に引き寄せて、自分のものに変換できることです。stars-digest は、その変換を毎朝少しずつやるための、自分用の小さな道具でもあります。
