...
import reflectionsOn2025Og from '../../../assets/og/2025.png';

<SiteImage src={reflectionsOn2025Og} alt="og" variant="articleHeader" style="width: 100%; height: auto;" />
...
<SiteImage src={nextImage} alt="next" variant="inline" />
...
<SiteImage src={tourImage} alt="tour" variant="inline" />
...
<SiteImage src={dmImage} alt="dm" variant="inline" />
...
<SiteImage src={bookCoverImage} alt="book-cover" variant="inline" />
