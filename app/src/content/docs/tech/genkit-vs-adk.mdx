...
- **Languages**: Python (GA May 2025, ~10 months ahead of the others), Go (v1.0 stable, Mar 2026), Java (v1.0 stable, Mar 2026), TypeScript (v1.0 stable, Apr 2026). v2.0 is Python-only and in Beta phase
...
| **Java** | Not supported | v1.0 stable (Mar 2026) |

If your team writes Python and prioritizes production stability, ADK (v1.x GA since May 2025, well-proven) is the natural choice — and v2.0 Beta is on the table if you want to explore graph-based orchestration. For Go teams, both Genkit Go and ADK Go are at v1.x stable, so the decision comes down to use case (embed in an existing app vs build multi-agent). Dart / Flutter teams: Genkit Dart (Preview) is the realistic option. Java teams: ADK is the only choice.
...
<RichLinkCard href="https://developers.googleblog.com/announcing-genkit-middleware-intercept-extend-and-harden-your-agentic-apps/" title="Announcing Genkit Middleware" description="Official announcement of Genkit Middleware: cross-cutting extensions across Generate / Model / Tool layers." />

<RichLinkCard href="https://mastering-genkit.github.io/mastering-genkit-go/chapters/04-mastering-ai-generation.html" title="Mastering Genkit: Middleware Chapter" description="Walk-through of middleware patterns for cross-cutting concerns." />

<RichLinkCard href="https://github.com/gemini-cli-extensions/genkit" title="Genkit Extension for Gemini CLI" description="Invoke Genkit flows, traces, and code generation directly from Gemini CLI." />
...
<RichLinkCard href="https://adk.dev/2.0/" title="ADK 2.0 (Beta)" description="Graph-based Workflow runtime and Task API. Python only, Beta phase." />
