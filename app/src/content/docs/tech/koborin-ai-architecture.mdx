...
<table>
  ...
  <tbody>
    <tr><td><code>Dev access</code></td><td><SiteImage src={iap1Image} alt="iap-1" variant="inline" /></td></tr>
    <tr><td><code>Dev access denied</code></td><td><SiteImage src={iap2Image} alt="iap-2" variant="inline" /></td></tr>
  </tbody>
</table>
