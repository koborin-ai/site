...
import mcpDeepDiveOg from '../../../assets/og/mcp-deep-dive.png';

<SiteImage src={mcpDeepDiveOg} alt="MCP Deep Dive" variant="hero" widths={[375, 750, 1500]} style="width: 100%; height: auto;" />
