...
import pluginMarketplaceOg from '../../../assets/og/plugin-marketplace.png';

<SiteImage src={pluginMarketplaceOg} alt="Plugin Marketplace on koborin.ai" variant="hero" widths={[375, 750, 1500]} style="width: 100%; height: auto;" />
